...
1. [`@folio-org/linked-data`](https://github.com/folio-org/ui-linked-data) (also known as `ui-linked-data`, `linked-data`). This module needs to be built as a library in order for `ui-bf-folio-wrapper` to work. Refer to point 1 from its [Usage: As an embedded application](https://github.com/folio-org/ui-linked-data?tab=readme-ov-file#as-an-embedded-application) section on how to do so.
